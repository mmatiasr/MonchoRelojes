...
%>
  <header>
    ...
    <% if (nombreUsuario != null && !nombreUsuario.isEmpty()) { %>
      <div style="position: fixed; top: 16px; left: 250px; color: white; font-family: 'Raleway', sans-serif; z-index: 1001; font-size: 23px;">
  ...
  <main class="container mt-5 pt-5">
    ...
    <h3 class="mt-5 mb-3">Cambiar Contraseña</h3>
<form method="post" action="CambiarClave.html">
    ...
    <div class="mb-3">
        ...
        <input type="password" class="form-control" name="nuevaClave" required>
    </div>
    <div class="mb-3">
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-warning mt-3">Cambiar Contraseña</button>
    </div>
</form>
